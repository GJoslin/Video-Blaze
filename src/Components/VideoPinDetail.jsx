...
const VideoPinDetail = () => {
  ...
  const handleProgress = (changeState) => {
    if (!seeking) {
      setPlayed(changeState.played); // played fraction
    }
  };
              ...
              >
                ...
                <Flex width="full" alignItems="center" my={2} gap={10}>
                  ...
                  <Box onClick={() => setIsPlaying(!isPlaying)}>
                    {!isPlaying ? (
                      <IoPlay fontSize={30} color="#f2f2f2" />
                    ) : (
                      <IoPause fontSize={30} color="#f2f2f2" />
                    )}
                  </Box>
                  ...
                  <Flex alignItems="center">
                    <Box onClick={() => setMuted(!muted)}>
                      {!muted ? (
                        <MdVolumeUp fontSize={30} color="#f1f1f1" />
                      ) : (
                        <MdVolumeOff fontSize={30} color="#f1f1f1" />
                      )}
                    </Box>
